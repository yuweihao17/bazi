...
"""Compatibility layer: run the complete historical feature set by default."""

# The original implementation above is retained for source compatibility, but
# the optimized calculator is the canonical application entry point.
from bazi_calculator import *  # noqa: F401,F403
